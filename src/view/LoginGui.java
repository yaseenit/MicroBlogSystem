...
public class LoginGui extends javax.swing.JFrame {
    private String   Nick_Name = "Nick Name";
    ...
    private void initComponents() {
        ...
        try {
            nickName =(javax.swing.JTextField)java.beans.Beans.instantiate(getClass().getClassLoader(), "view.LoginGui_nickName");
        ...
        nickName.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseExited(java.awt.event.MouseEvent evt) {
                nickNameMouseExited(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                nickNameMouseEntered(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addComponent(nickName, javax.swing.GroupLayout.DEFAULT_SIZE, 397, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(nickName, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        setSize(new java.awt.Dimension(506, 145));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void nickNameMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_nickNameMouseClicked
         if(nickName.getText().toString().equals(this.Nick_Name) || 
                 "".equals(nickName.getText()))
    ...
    private void jPanel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseClicked
       if("".equals(nickName.getText()))
                 this.nickName.setText("Nick Name");
    ...
    private void nickNameMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_nickNameMouseEntered
        if(nickName.getText().toString().equals(this.Nick_Name) || 
                 "".equals(nickName.getText()))
                 this.nickName.setText("");
       
    }//GEN-LAST:event_nickNameMouseEntered
    ...
    private void nickNameMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_nickNameMouseExited
       if( "".equals(nickName.getText()))
                 this.nickName.setText("Nick Name");
    }//GEN-LAST:event_nickNameMouseExited
